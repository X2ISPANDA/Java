...
![image-20200624194252580](https://i.loli.net/2020/06/24/lOpXDqnVWor2CRc.png)
...
**spring-boot-starter**-web：spring-boot-starter：spring-boot场景启动器；**spring-boot-starter**-web帮我们导入了web模块正常运行所依赖的组件；
...
![image-20200531023223202](https://i.loli.net/2020/06/24/5xZrGw8DF6LYsgf.png)
...
3. 激活指定Profile
   ...
   3. 虚拟机参数
      ...
      ![image-20200531192456919](https://i.loli.net/2020/06/24/BWlzHTogErjfRNs.png)
...
2而我们在全局配置文件中的配置通过@ConfigurationProperties绑定到相对应的Properties结尾的配置类
