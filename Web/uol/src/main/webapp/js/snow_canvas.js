...
var RENDERER = {
    ...
    render: function () {
        ...
        var gradient = this.context.createRadialGradient(this.center.x, this.center.y, 0, this.center.x, this.center
                .y, this.radius),
...
SNOW.prototype = {
    ...
    render: function (context) {
        ...
        if (this.scale > this.THRESHOLD_TRANSPARENCY) {
            ...
            if (this.scale > 1 || this.x < -this.radius || this.x > this.width + this.radius || this.y < -this.radius ||
