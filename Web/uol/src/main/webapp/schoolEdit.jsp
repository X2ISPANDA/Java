            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="commentForm" action="school">
                        <input type="hidden" name="method" value="editSchool"/>
                        <input type="hidden" name="id" value="${school.id}">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">学校名称：</label>
                            <div class="col-sm-8">
                                <input id="schoolName" name="schoolName" value="${school.schoolName}" type="text" required class="form-control">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea id="ccomment" name="remark" required minlength="10" class="form-control"  aria-required="true">${school.remark}</textarea>
                            </div>
                        </div>
