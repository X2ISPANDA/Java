            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div style="margin: 8px 0px;">
                        <form role="form" class="form-inline" action="${pageContext.request.contextPath}/dept">
                            <div class="form-group">
                                院系名称：<input type="text" name="schoolName" value="${schoolName}" id="exampleInputEmail2" class="form-control">
